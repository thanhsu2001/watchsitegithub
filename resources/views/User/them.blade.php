            ...
            <div class="user_card">
                <div class="d-flex justify-content-center">
                    <div class="brand_logo_container">
                        <img src="{{asset('storage/favicon.png')}}" class="brand_logo" alt="Logo">
                    </div>
                </div>
                <div class="d-flex justify-content-center form_container">
                    <form action="{{ route('user.loginuser') }}" method="post" autocomplete="off">
                        ...
                        <x-input name="confirmpassword" type="password" label="Nhập lại mật khẩu" />
                        @if (Auth::user())
                            @if (Auth::user()->is_admin)
                                <div class="mt-3">
                                    <label>
                                        <input name="is_admin" type="checkbox">Đây là tài khoản admin
                                    </label>
                                </div>
                            @endif
                        @endif
                ...
                <div>
                    <div class="d-flex justify-content-center links">
                        Already have an account? <a href="{{ route('user.login') }}" class="ml-2">Log in</a>
                    </div>
